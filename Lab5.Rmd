...
betting <- function(guess, throws) {
  # at least one "guess"" appears in "throws" throws of a die.
  for(i in 1:throws) {
    result <- rolling()
    print(result)
    if(guess == result) {
...
betting(6, 1000) # guess at least one 6 in 1000 throws of a die
betting(6, 10000) # guess at least one 6 in 10000 throws of a die
```
